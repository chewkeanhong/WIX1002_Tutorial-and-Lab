...
public class L6Q6 {
    public static void main(String[] args) {
        display20palindromePrime("Palindrome Prime: ");
        display20Emrip("Emrip: ");
    }
 
    
    public static void display20palindromePrime(String a){
        System.out.print(a);
        int ct = 0;
        int num = 2;
        while(ct < 20){
    ...
    public static void display20Emrip(String b){
        System.out.print(b);
        int ct = 0;
        int num = 2;
        while(ct < 20){
